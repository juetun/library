...
type (
	...
	ExcelImportHeaderRelateItem struct {
		...
		ColumnSupportEdit uint8                 `json:"column_support_edit,omitempty"`
		ColumnType        string                `json:"column_type,omitempty"`    //字段类型
		ColumnOptions     base.ModelItemOptions `json:"column_options,omitempty"` //字段选项
